...
class CoarseLMModelBase
{
public:
  virtual ~CoarseLMModelBase() {}
...
class CoarseLMModel : public CoarseLMModelBase
{
public:
	CoarseLMModel(const std::string& file)
